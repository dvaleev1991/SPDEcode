...
for i = 1:numel(narr) %0.0090:0.0001:0.0125
    ...
    Cbs_010=(Cbs_010*0.5032+0.0135+bidask)/0.5032;%0.00300
    Cbs_015=(Cbs_015*0.4643+0.0182+bidask)/0.4643;%0.00350
    Cbs_020=(Cbs_020*0.3682+0.0424+bidask)/0.3682;%0.00392
    Cbs_025=(Cbs_025*0.2508+0.1082+bidask)/0.2508;%0.00392
    ...
    ImpVol_025 = blsimpv(Sn3, K3, r, tau_025, Cbs_025,'Class', {'Call'});
...
hold on;
plot(KCollection1,ImpVolCollection_025,'m-o','linewidth',1)
...
h=legend('$\psi$=0.05','$\psi$=0.10','$\psi$=0.20','$\psi$=0.30');
...
hold on;
plot(KCollection1,CbsCollection_025,'m-','linewidth',1)
xlabel('LMMR, spread quotation','Interpreter','latex')
